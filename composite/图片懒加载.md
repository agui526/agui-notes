> 原文地址(http://www.cnblogs.com/haoyijing/p/5818236.html)
...
　　原文链接: jQuery图片预加载(延迟加载)插件Lazy Load
2. JS实现图片预加载
...
14
15
16	function getPreloadImgAttr(url,callback){
...
6
7
8	function loadImage(url, callback) {    
